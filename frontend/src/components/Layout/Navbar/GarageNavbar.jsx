...
export default function TopNavbar({ userName = "User", onToggleSidebar }) {
  ...
  return (
    <>
      <header
        className={`
          h-14 xs:h-14 sm:h-16 md:h-20 flex items-center px-3 xs:px-4 sm:px-6 md:px-8 sticky top-0 transition-all duration-300 z-40
                ...
                {menuOpen && (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <button
                        onClick={logout}
                        className="group flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-slate-600 dark:text-zinc-400 transition-all hover:bg-red-500/10 hover:text-rose-500 dark:hover:text-rose-400"
                      >
                        <div className="flex h-8 w-8 items-center justify-center rounded-md bg-slate-100 dark:bg-zinc-800 transition-colors group-hover:bg-red-500/20 group-hover:text-rose-500 dark:group-hover:text-rose-400">
                          <LogOut size={16} />
                        </div>
                        Sign Out
                      </button>
